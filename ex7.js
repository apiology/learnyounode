...
// to you as the first command-line argument. Write the String
// contents of each "data" event from the response to a new line on
// the console (stdout).
...
// browser here:
// file:///opt/local/lib/node_modules/learnyounode/node_apidoc/http.html
...
// Node Streams as objects that emit events. The three events that are
// of most interest are: "data", "error" and "end". You listen to an
// event like so:

// response.on("data", function (data) { /* ... */ })

// The "data" event is emitted when a chunk of data is available and
// can be processed. The size of the chunk depends upon the underlying
// data source.

// The response object / Stream that you get from http.get() also has
// a setEncoding() method. If you call this method with "utf8", the
// "data" events will emit Strings rather than the standard Node
