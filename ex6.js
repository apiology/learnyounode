...
// directory name and the second argument is the extension
// filter. Print the list of files (one file per line) to the
// console. You must use asynchronous I/O.
...
var filePrinter = require('./ex6_file_printer');

filePrinter(dirname, fileExtension, function(err, list) {
    if (err) {
        console.log(err);
        process.exit(1);
    } else {
...
// You must write a module file to do most of the work. The module
// must export a single function that takes three arguments: the
// directory name, the filename extension string and a callback
// function, in that order. The filename extension argument must be
// the same as what was passed to your program. Don't turn it into a
// RegExp or prefix with "." or do anything except pass it to your
// module where you can do what you need to make your filter work.
...
//   In the case of an error bubbling up to your original program
//   file, simply check for it and print an informative message to
//   the console.
...
// directory reading and filtering function. To define a single
// function export, you assign your function to the module.exports
// object, overwriting what is already there:
